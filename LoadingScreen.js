...
for(var k = 0; k < numOfCircles; k++) {
  ...
  let animationDelay = k * (0.681 * 0.8)//k / (0.681 * 1); //Controls the time between dots
  let orbitDelay = k / (0.618 * 2)  
  let animationDuration =  0.681 * 3; //2//Controls the speed of the circles
  let rotationSpeed = 0.681 * 6; //3//Controls the speed of Cycles
